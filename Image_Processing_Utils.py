...
xdim = 64
ydim = 64
samples = sample_images(image, xdim, ydim, 2)




image_reconstruction = utils.make_grid(torch.Tensor(np.expand_dims(samples,1)), nrow = image.shape[1] // ydim, padding = 0)[0]
#diff = image[0:1664,0:2560] - image_reconstruction.detach().numpy()
'''
